    ...
    <div class="max-w-6xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        <div class="flex-none md:flex justify-between gap-32">
            ...
            <div class="w-full md:w-1/2 mt-10 sm:mt-0">
                ...
                <div>
                    <Link href="{{ route('register') }}" class="inline-flex uppercase font-bold justify-center mt-5 items-center rounded-sm border border-pink-500 px-3 py-3 leading-4 text-pink-500 hover:bg-pink-500 hover:text-white focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2">

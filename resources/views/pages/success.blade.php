<x-guest-layout>
    <div class="max-w-4xl mx-auto pt-10 pb-10 px-4 sm:px-6 lg:px-8 space-y-4 prose text-justify">
            ...
            <div class="mt-8 max-w-xl mx-auto">
                ...
                <div class="px-4 mt-4">
                    <div class="max-w-[230px] mx-auto">
                        <button onclick="copyToClipboard('{!! $order->payment_action->pix_qrcode !!}')" class="cursor-pointer mx-auto text-white uppercase text-sm bg-pink-600 whitespace-nowrap font-medium flex justify-center items-center rounded-md py-2 px-4">
                            Copiar e pagar
        ...
        <div>
            ...
            <div class="px-4 mt-4">
                <div class="max-w-[230px] mx-auto">
                    <a href="{{ $order->payment_action->boleto_link }}" target="_blank" class="cursor-pointer uppercase text-sm bg-pink-600 text-white whitespace-nowrap font-medium flex justify-center items-center rounded-md py-2 px-4">
                        Baixar boleto
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 ml-2">
